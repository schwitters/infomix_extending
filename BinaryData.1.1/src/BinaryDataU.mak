# This Makefile builds the BinaryData DataBlade.
...
$(BINDIR)/BinaryType.$(OBJSUFF) : c/BinaryType.c
	$(CC) $(CFLAGS) -o $@ -c $?

c/udr.c :  c/$(PROJECT_TITLE).h

c/BinaryType.c :  c/$(PROJECT_TITLE).h
