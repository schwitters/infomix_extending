...
#ifndef HDR_BinaryData_H
#define HDR_BinaryData_H

/*
**  Configure tracing by setting TRACE_DEBUG_BinaryData
**  to 0 to completely disable tracing or 1 to  enable
**  tracing.  This define can be set from the compiler
**  command line by using the -DTRACE_DEBUG_BinaryData=0 flag.
*/
#ifndef TRACE_DEBUG_BinaryData
#define TRACE_DEBUG_BinaryData 1
#endif
...
/*
** BladeSmith 4.00.TC1B typedef BinaryType
...
BinaryType;
/* Warning: Do not modify. BinaryType checksum: 0 */
