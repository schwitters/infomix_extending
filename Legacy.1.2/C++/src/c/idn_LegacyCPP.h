...
#ifndef HDR_idn_LegacyCPP_H
#define HDR_idn_LegacyCPP_H

/*
**  Configure tracing by setting TRACE_DEBUG_idn_LegacyCPP
**  to 0 to completely disable tracing or 1 to  enable
**  tracing.  This define can be set from the compiler
**  command line by using the -DTRACE_DEBUG_idn_LegacyCPP=0 flag.
*/
#ifndef TRACE_DEBUG_idn_LegacyCPP
#define TRACE_DEBUG_idn_LegacyCPP 1
#endif
