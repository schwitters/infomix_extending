...
#ifndef HDR_idn_LegacyC_H
#define HDR_idn_LegacyC_H

/*
**  Configure tracing by setting TRACE_DEBUG_idn_LegacyC
**  to 0 to completely disable tracing or 1 to  enable
**  tracing.  This define can be set from the compiler
**  command line by using the -DTRACE_DEBUG_idn_LegacyC=0 flag.
*/
#ifndef TRACE_DEBUG_idn_LegacyC
#define TRACE_DEBUG_idn_LegacyC 1
#endif
