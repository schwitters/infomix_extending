...
--     17. Union query
--
--   Additional trace output is to /tmp/mrLvarchar_stm.trc.
-- ---------------------------------------------------------------

--
-- Turn tracing on.
--
execute procedure TraceSet_mrLvarchar ("/tmp/mrLvarchar_stm.trc", 20);
...
--
-- Set intermediate storage to PER_STATEMENT.
--
...
-- cached in PER_STATEMENT memory by Input.
...
-- rename the explain output file to 'sqexplain.stm.log'
!mv -f sqexplain.out sqexplain.stm.log
