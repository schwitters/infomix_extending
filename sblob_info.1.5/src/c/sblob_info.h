...
** CCid:           %W% %E% %U%
** Author:         Informix
** Created:        06/07/2000 13:12
** Description:    This is a generated source file for the sblob_info DataBlade module.
** Comments:       Generated for project sblob_info.1.4
*/
...
#ifndef HDR_sblob_info_H
#define HDR_sblob_info_H

/*
**  Configure tracing by setting TRACE_DEBUG_sblob_info
**  to 0 to completely disable tracing or 1 to  enable
**  tracing.  This define can be set from the compiler
**  command line by using the -DTRACE_DEBUG_sblob_info=0 flag.
*/
#ifndef TRACE_DEBUG_sblob_info
#define TRACE_DEBUG_sblob_info 1
#endif
...
/*
** The following area is reserved for user additions.
** Your changes here will be preserved when  code  is
** regenerated if code merging  is  enabled  (see the
** Merge property value  for  the  DataBlade  node on
** the Generate   DataBlade  dialog  in  BladeSmith).
** Changes must be contained within the merge header/
** footer.
*/

/* {{FUNCTION(b9c0d30d-1dc4-11D3-8a74-00c04f79b326) (PreserveSection) */
