...
echo "main.sh "
echo " "
echo "	Step 1: Create the test database and register the sblob_info DataBlade"
echo " "
...
then
	...
	echo "	Demo Succeeded."
	echo " "
	echo "  See /tmp/sblob_info.trc for detailed output. You can clean "
	echo "  this and all other temporary files by running the "
	echo "  clean.sh script. If you run this demo again without"
	echo "  cleaning up, then subsequent output will be appended"
	echo "  to the existing sblob_info.trc file."
	echo " "
fi
echo " "
