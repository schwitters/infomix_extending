...
echo "======================================================================"
echo "==                                                                  =="
echo "== f.     Unload and Re-Load, along with another test of the index. =="
echo "==                                                                  =="
echo "======================================================================"
rem --
dbaccess -e period < Load_Unload.sql
rem --
dbaccess -e period < create_index.sql 
dbaccess -e period < update_stats.sql
rem --
dbaccess -e period < d_stat_queries.sql > d_stat_tests_4.txt
dbaccess -e period < dt_stat_queries.sql > dt_stat_tests_4.txt
rem --
rem --    OK. I tested the ontape, but not onbar. The ontape recovered the
rem --  database without an error.
rem --
