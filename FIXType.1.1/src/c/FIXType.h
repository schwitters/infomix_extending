...
#ifndef HDR_FIXType_H
#define HDR_FIXType_H

/*
**  Configure tracing by setting TRACE_DEBUG_FIXType
**  to 0 to completely disable tracing or 1 to  enable
**  tracing.  This define can be set from the compiler
**  command line by using the -DTRACE_DEBUG_FIXType=0 flag.
*/
#ifndef TRACE_DEBUG_FIXType
#define TRACE_DEBUG_FIXType 1
#endif
...
/*
** BladeSmith 4.00.TC1B typedef FIXType
...
FIXType;
/* Warning: Do not modify. FIXType checksum: 0 */
