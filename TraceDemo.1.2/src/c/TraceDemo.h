...
#ifndef HDR_TraceDemo_H
#define HDR_TraceDemo_H

/*
**  Configure tracing by setting TRACE_DEBUG_TraceDemo
**  to 0 to completely disable tracing or 1 to  enable
**  tracing.  This define can be set from the compiler
**  command line by using the -DTRACE_DEBUG_TraceDemo=0 flag.
*/
#ifndef TRACE_DEBUG_TraceDemo
#define TRACE_DEBUG_TraceDemo 1
#endif
