...
#ifndef HDR_idn_socket1_H
#define HDR_idn_socket1_H

/*
**  Configure tracing by setting TRACE_DEBUG_idn_socket1
**  to 0 to completely disable tracing or 1 to  enable
**  tracing.  This define can be set from the compiler
**  command line by using the -DTRACE_DEBUG_idn_socket1=0 flag.
*/
#ifndef TRACE_DEBUG_idn_socket1
#define TRACE_DEBUG_idn_socket1 1
#endif
