========================================================================
                     DBDK DataBlade Project Node
========================================================================


BladeSmith Version 3.70.TC1 has created the Node
...
that make up your Node DataBlade module.
...
Node.c
	...
	Node DataBlade module for the opaque
	type Node.

udr.c

	This file contains all the User Defined Routines,
	Iterators and Aggregates of the Node DataBlade module.

support.c

	This file contains all the support functions that are required
	for the Node DataBlade module.

Node.def

	This file contains a list of all exported C functions
	declared in the Node DataBlade module.
	This file is used by Microsoft's Visual C++ linker.

WinNT.mak

	This is the NT nmake makefile.

UNIX.mak

	This is the UNIX make file.

Node.mak

	This is the Microsoft VC++ 4.2 project file for your DataBlade module.
